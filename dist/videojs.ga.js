...
(function () {
    ...
    videojs.registerPlugin('ga', function (options) {
        var dataSetupOptions, defaultsEventsToTrack, end, error, eventCategory, eventLabel, eventsToTrack, fullscreen,
            loaded, parsedOptions, pause, percentsAlreadyTracked, percentsPlayedInterval, play, resize, seekEnd,
            seekStart, seeking, sendbeacon, timeupdate, volumeChange, adstart, adend;
        if (options == null) {
            options = {};
        }
        dataSetupOptions = {};
        ...
        defaultsEventsToTrack = ['loaded', 'percentsPlayed', 'start', 'end', 'seek', 'play', 'pause', 'resize', 'volumeChange', 'error', 'fullscreen', 'adstart', 'adend'];
        ...
        adstart = function () {
            sendbeacon('adstart', false);
        };

        adend = function () {
            var currentTime = Math.round(this.currentTime());
            sendbeacon('adend', true, currentTime);
        };
